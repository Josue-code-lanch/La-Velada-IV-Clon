    ...
    return (
        <section className='info-section'>
            <div className='twitch-logo'>
                <a href="https://www.twitch.tv/ibai" target="_blank" rel="noopener noreferrer">
            ...
            <div className='info-grid md:grid-cols'>
                ...
                <article className='twitch'>
                    <a href="https://www.twitch.tv/ibai" rel='noopener noreferrer' target='_blank'>
                        <h4>Síguelo en directo twitch.tv/ibai</h4>
                    </a>
                </article>
