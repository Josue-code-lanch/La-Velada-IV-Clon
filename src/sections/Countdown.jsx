...
const Countdown = () => {
  const TIMESTAMP_END = 1720729143000;
  ...
  return (
    <section className="section-countdown">
      ...
      <div data-date={TIMESTAMP_END} className="contador">
        <div className="date">
          <span className="numbers" data-days>
            00
          </span>
          <span className="fecha">Días</span>
        </div>

        <span className="points" aria-hidden="true">
          :
        </span>

        <div className="date">
          <span className="numbers" data-hours>
            00
          </span>
        ...
        <div className="date">
          <span className="numbers" data-minutes>
            00
          </span>
        ...
        <div className="date">
          <span className="numbers" data-seconds>
            00
          </span>
